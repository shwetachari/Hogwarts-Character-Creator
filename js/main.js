...
if (house == "gry"){
  housePath = "img/crestG.png";
  house = "Gryffindor";
} else if (house == "huf"){
  housePath = "img/crestH.png";
  house = "Hufflepuff";
} else if (house == "rav"){
  housePath = "img/crestR.png";
  house = "Ravenclaw";
} else if (house == "sly"){
  housePath = "img/crestS.png";
  house = "Slytherin";
}
    ...
    familiarArray = [
      {
        ...
        familiarImg:"img/comnatToad.png"
      },
      {
      ...
      },
      {
        ...
        familiarImg:"img/draToad.png"
      },
      {
        familiarName:"harlequin toad",
        familiarImg:"img/harToad.png"
      },
      {
        familiarName:"three toed toad",
        familiarImg:"img/thrToad.png"
      }
    ]
  } else if (animal == "cat"){
    familiarArray = [
      {
        ...
        familiarImg:"img/tabCat.png"
      },
      {
        familiarName:"siamese cat",
        familiarImg:"img/siaCat.png"
      },
      {
        familiarName:"ginger cat",
        familiarImg:"img/ginCat.png"
      },
      {
        familiarName:"black cat",
        familiarImg:"img/blaCat.png"
      },
      {
        familiarName:"white cat",
        familiarImg:"img/whiCat.png"
      }
    ]
  } else if (animal == "owl"){
    familiarArray = [
      {
        ...
        familiarImg:"img/tawOwl.png"
      },
      {
        familiarName:"screech owl",
        familiarImg:"img/scrOwl.png"
      },
      {
        familiarName:"brown owl",
        familiarImg:"img/broOwl.png"
      },
      {
        familiarName:"snowy owl",
        familiarImg:"img/snoOwl.png"
      },
      {
        familiarName:"barn owl",
        familiarImg:"img/barOwl.png"
      }
    ]
  }
...
function genResults() {
  ...
  var charInfo = new character(firstName + " " + lastName, gender, house, housePath, familiar, familiarPath, wandWood, wandCore, eye, "img/" + avi + ".png", email);
